<div class="containerCertificate w-full">
        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="searchData" class="w-full">
                ...
                <div class="mt-4 w-full">
                    <x-input wire:model="search" type="text" name="search" class="" required />
    ...
    <x-modal wire:model="modal" title="Constancias Extraescolares" subtitle="" separator>
        ...
        <h1 class="text-neutral-950">
            No se encontró ninguna coincidencia con la matrícula <span
                class="uppercase font-medium">{{ $search }}</span>
        </h1>
        <x-slot:actions>
